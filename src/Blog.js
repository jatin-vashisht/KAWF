...
const Blog = () => {
  return (
    <div className='blog-container'>
      <div className='blog'>
        <h5 className='blog-tag'>Why Donate? </h5>
        <p className='blog-text'>
          Animal Rescue becomes a difficult task when there is passion in the
      ...
      <div className='blog'>
        <h5 className='blog-tag'>Our Goals</h5>
        <p className='blog-text'>
          Animals deserve as much help and support as humans do. We have some
